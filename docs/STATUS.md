...
| --- | --- | ---: | ---: | ---: |
| **M0** Plan | `########################` 100% | 26 | 26 | 0 |
| **M1** Control plane skeleton | `###################-----` 78% | 47 | 60 | 5 |
| **M2** Agent and first host | `#####-------------------` 21% | 6 | 29 | 15 |
...
| --- | ---: | --- | --- | ---: | --- |
| `RL-M1-015` | 4d | agent | medium | 2/3 | Schedule audit chain verification and surface its result |
